    ...
    <html lang='en'>
        ...
        <body>
			...
			<div class="col-lg-6 u_row">
				    ...
				    <div class="col-sm-6">
					<input name="firstname" type="text" class="form-control" value="<?php echo $_SESSION['first_name'];?>" />
				    </div>
				    </div>
				    ...
				    <div class="form-group">
				      ...
				      <div class="col-sm-6">
					<input name="lastname" type="text" class="form-control" value="<?php echo $_SESSION['last_name'];?>"/>
				      </div>
				    </div>
			    ...
			    <legend>Contacts:</legend>
				  ...
				  <div class="col-sm-6">
				    <input name="email" type="text" class="form-control" value="<?php echo $_SESSION['email_address'];?>"/>
				  </div>
				</div>
			       <div class="form-group">
				  <label class="col-sm-2 control-label" >Cell phone:</label>
				  <div class="col-sm-6">
				    <input name="phonenumber" type="text" class="form-control" value="<?php echo $_SESSION['phone_number'];?>"/>
				  </div>
				</div>
